...
function submitDecision() {
    ...
    if (data.decision === null) {
        alert(
            "You must choose to accept or reject your TA appointment confirmation for the upcoming term before submitting."
        );
        return;
    }
    ...
    var confirmation = confirm(
        "Are you sure you want to " +
            data.decision +
            " your offer to take up TA appointment hours in the upcoming Fall/Winter term?"
    );
    if (!confirmation) {
        return;
    }
