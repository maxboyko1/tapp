...
> = {
    ...
    taPositionPref: {
        ...
        func: filterByTaPref,
        values: [
            { label: "1st Choice", value: 4 },
            { label: "2nd Choice", value: 3 },
            { label: "3rd Choice", value: 2 },
            { label: "4th Choice", value: 1 },
            { label: "Willing", value: 0 },
            { label: "Unwilling", value: -1 },
        ],
        hasOther: true,
    },
    status: {
        ...
        values: [
            ...
            { label: "Tentatively Assigned", value: "tentative" },
