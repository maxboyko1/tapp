...
const Landing = React.lazy(() => import("../admin-header/landing"));
const PostingDetails = React.lazy(() => import("../postings/posting-details"));
const PostingOverview = React.lazy(() => import("../postings/overview"));
const PostingPreview = React.lazy(() => import("../postings/posting-preview"));
