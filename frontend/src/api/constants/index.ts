...
export const FETCH_ALL_POSITIONS_SUCCESS = "FETCH_ALL_POSITIONS_SUCCESS";
...
export const EMAIL_ONE_POSITION_SUCCESS = "EMAIL_ONE_POSITION_SUCCESS";
...
// `confirmation`-related constants
export const FETCH_CONFIRMATIONS_SUCCESS = "FETCH_CONFIRMATIONS_SUCCESS";
export const FETCH_ONE_CONFIRMATION_SUCCESS = "FETCH_ONE_CONFIRMATION_SUCCESS";
export const UPSERT_ONE_CONFIRMATION_SUCCESS = "UPSERT_ONE_CONFIRMATION_SUCCESS";
export const DELETE_ONE_CONFIRMATION_SUCCESS = "DELETE_ONE_CONFIRMATION_SUCCESS";
export const SET_CONFIRMATION_ACCEPTED_SUCCESS = "SET_CONFIRMATION_ACCEPTED_SUCCESS";
export const SET_CONFIRMATION_REJECTED_SUCCESS = "SET_CONFIRMATION_REJECTED_SUCCESS";
...
export const CONFIRMATION_NAG_SUCCESS = "CONFIRMATION_NAG_SUCCESS";
export const CONFIRMATION_WITHDRAW_SUCCESS = "CONFIRMATION_WITHDRAW_SUCCESS";

// `letter_template`-related constants
export const FETCH_LETTER_TEMPLATES_SUCCESS =
    "FETCH_LETTER_TEMPLATES_SUCCESS";
export const FETCH_ONE_LETTER_TEMPLATE_SUCCESS =
    "FETCH_ONE_LETTER_TEMPLATE_SUCCESS";
export const UPSERT_ONE_LETTER_TEMPLATE_SUCCESS =
    "UPSERT_ONE_LETTER_TEMPLATE_SUCCESS";
export const DELETE_ONE_LETTER_TEMPLATE_SUCCESS =
    "DELETE_ONE_LETTER_TEMPLATE_SUCCESS";
export const FETCH_ALL_LETTER_TEMPLATES_SUCCESS =
...
// `applicant_matching_datum`-related constants
export const FETCH_APPLICANT_MATCHING_DATA_SUCCESS =
    "FETCH_APPLICANT_MATCHING_DATA_SUCCESS";
export const FETCH_ONE_APPLICANT_MATCHING_DATUM_SUCCESS =
    "FETCH_ONE_APPLICANT_MATCHING_DATUM_SUCCESS";
export const UPSERT_ONE_APPLICANT_MATCHING_DATUM_SUCCESS =
    "UPSERT_ONE_APPLICANT_MATCHING_DATUM_SUCCESS";
export const DELETE_ONE_APPLICANT_MATCHING_DATUM_SUCCESS =
    "DELETE_ONE_APPLICANT_MATCHING_DATUM_SUCCESS";
export const FETCH_CONFIRMATIONS_FOR_APPLICANT_MATCHING_DATUM_SUCCESS =
    "FETCH_CONFIRMATIONS_FOR_APPLICANT_MATCHING_DATUM_SUCCESS";
export const UPSERT_CONFIRMATIONS_FOR_APPLICANT_MATCHING_DATUM_SUCCESS =
    "UPSERT_CONFIRMATIONS_FOR_APPLICANT_MATCHING_DATUM_SUCCESS";

// `match`-related constants
export const FETCH_MATCHES_SUCCESS = "FETCH_MATCHES_SUCCESS";
export const FETCH_ONE_MATCH_SUCCESS = "FETCH_ONE_MATCH_SUCCESS";
export const UPSERT_ONE_MATCH_SUCCESS = "UPSERT_ONE_MATCH_SUCCESS";
export const DELETE_ONE_MATCH_SUCCESS = "DELETE_ONE_MATCH_SUCCESS";
